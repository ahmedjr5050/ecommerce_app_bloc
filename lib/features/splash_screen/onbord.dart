import 'package:app2/features/auth/signin/presention/signinview.dart';
import 'package:app2/features/splash_screen/shape_image_positions.dart';
          ...
          ..addStatusListener((status) {
            if (status == AnimationStatus.completed) {
              Navigator.pushReplacement(
                  context,
                  PageTransition(
                      child: const MyLogin(), type: PageTransitionType.fade));
            }
          });
  }
